    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                <div>
                    <h1 className="text-[22px] font-semibold tracking-tight ros-fg" data-testid="page-title">{title}</h1>
                    {subtitle && (
                        <div className="mt-1 text-sm ros-muted" data-testid="page-subtitle">
                            {subtitle}
                        </div>
                    )}
                </div>
